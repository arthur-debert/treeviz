...
def test_complex_nested_extraction(assert_node):
    ...
    class NestedNode:
        def __init__(self):
            ...
            self.content = type('obj', (object,), {'lines': ['line1', 'line2', 'line3']})()
    ...
    assert_node(result).has_label("Nested Title").has_type("nested").has_content_lines(3)